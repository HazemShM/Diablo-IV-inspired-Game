...
public class PlayerControllerSorcerer : MonoBehaviour
{   
    [SerializeField] private InputAction movement = new InputAction();
    [SerializeField] private LayerMask layerMask = new LayerMask();
    private NavMeshAgent agent = null;
    private Camera cam = null;
    [SerializeField] private SorcererAnimation sorcererAnimation;
    public event Action<float> OnSpeedChanged;

    private void Start(){
        cam = Camera.main;
        agent = GetComponent<NavMeshAgent>();
        OnSpeedChanged += sorcererAnimation.SetSpeed;
    }
